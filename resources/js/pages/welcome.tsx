            ...
            <div className="relative min-h-screen overflow-hidden bg-[#030712] text-white">
                ...
                <section className="mx-auto flex min-h-screen max-w-7xl items-center px-8">
                    <div className="grid w-full items-center gap-24 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <h1 className="text-6xl leading-[1.05] font-black lg:text-7xl">
                                Internship
                            ...
                            <p className="mt-10 max-w-xl text-lg leading-8 text-slate-400">
                                Submit accomplishment reports, monitor
                                attendance, manage rendered hours, communicate
                                with advisers, and track your internship
                                progress from one modern platform.
                            </p>
                ...
                <section className="relative mx-auto max-w-7xl px-8 py-32">
                    ...
                    <div className="mt-20 grid gap-6 lg:grid-cols-3">
                        ...
                        <div className="group rounded-[34px] border border-white/10 bg-white/5 p-10 backdrop-blur-xl transition duration-500 hover:-translate-y-3 hover:border-emerald-500/40 lg:row-span-2">
                            ...
                            <p className="mt-5 leading-8 text-slate-400">
                                Monitor attendance, rendered hours, adviser
                                approval, evaluations, and internship progress
                        ...
                        <div className="rounded-[34px] border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition duration-500 hover:-translate-y-2">
                            ...
                            <p className="mt-4 leading-7 text-slate-400">
                                Submit accomplishment reports with automatic
                        ...
                        <div className="rounded-[34px] border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition duration-500 hover:-translate-y-2">
                            ...
                            <p className="mt-4 leading-7 text-slate-400">
                                Connect students, companies, advisers, and
                                coordinators.
                            </p>
                        </div>
                        ...
                        <div className="rounded-[34px] border border-white/10 bg-gradient-to-r from-emerald-500/10 via-white/5 to-yellow-300/10 p-10 backdrop-blur-xl lg:col-span-2">
                            <div className="flex flex-col justify-between gap-10 lg:flex-row">
                                <div>
                                    ...
                                    <p className="mt-6 max-w-lg leading-8 text-slate-400">
                                        Student attendance, adviser approvals,
                                        rendered hours, weekly accomplishments,
                                        and company evaluations are available
                                        from one dashboard.
                                    </p>
                                </div>
                ...
                <section className="mx-auto max-w-7xl px-8 py-32">
                    ...
                    <div className="relative mt-24">
                        <div className="absolute top-0 left-1/2 h-full w-px -translate-x-1/2 bg-gradient-to-b from-emerald-500 via-yellow-300 to-emerald-500"></div>
                ...
                <footer className="border-t border-white/10">
                    <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 px-8 py-10 md:flex-row">
                        <div>
                            <h3 className="text-xl font-bold">OJT REPORT</h3>
