            ...
            <main className="relative min-h-svh overflow-hidden bg-[#030712] px-4 py-8 text-slate-100 sm:px-6">
                ...
                <div className="relative mx-auto max-w-3xl">
                    <div className="flex items-center justify-center gap-3">
                        ...
                        <div>
                            <p className="font-bold tracking-[0.16em]">
                                OJT REPORT
                            </p>
                    ...
                    <section className="mt-8 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] shadow-2xl shadow-black/30 backdrop-blur-xl">
                        <header className="border-b border-white/10 bg-gradient-to-r from-emerald-400/10 to-transparent p-6 sm:p-8">
                            ...
                            <h1 className="mt-2 text-2xl font-semibold tracking-tight sm:text-3xl">
                                Read and accept your OJT terms
                            </h1>
                            <p className="mt-3 text-sm leading-6 text-slate-400">
                                Please review the rules below. Your acceptance
                                date will be saved in the company audit log.
                            </p>
                        </header>
                        ...
                        <div className="max-h-[48vh] space-y-5 overflow-y-auto p-6 sm:p-8">
                            ...
                            >
                                Arrive ready to work by your company&apos;s
                                official time in. Record only your own
                                attendance, never ask another person to time in
                                for you, and submit accurate daily reports. Your
                                arrival is marked On time or Late using the
                                company schedule and grace period.
                            </Rule>
                            <Rule
                                icon={CheckCircle2}
                                title="Honest reports and corrections"
                            >
                                Daily summaries must truthfully describe your
                                work. If an attendance record is incorrect, use
                                the correction workflow and explain the reason.
                                Never alter, fabricate, or misrepresent
                                internship records.
                            </Rule>
                            <Rule
                                icon={ShieldCheck}
                                title="Privacy, safety, and respectful conduct"
                            >
                                Protect credentials and confidential
                                information, follow workplace safety
                                instructions, and do not send harassment,
                                threats, discriminatory content, or unauthorized
                                personal images through the system.
                            </Rule>
                            <div className="rounded-xl border border-white/10 bg-black/20 p-4 text-sm leading-6 text-slate-400">
                                Attendance labels support supervision and are
                                not automatic disciplinary findings. Approved
                                corrections remain auditable. Personal data is
                                used for internship administration, attendance,
                                reports, supervision, communication, and
                                legitimate compliance records.
                            </div>
                        </div>
